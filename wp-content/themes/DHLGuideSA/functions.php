...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bootstrapJS' , get_template_directory_uri() . '/style/Bootstrap/js/bootstrap.min.js', array('jquery'), '1.0.0');
...
function html5blank_styles()
{
    ...
    wp_register_style('bootstrapCSS', get_template_directory_uri() . '/style/Bootstrap/css/bootstrap.min.css', array(), '1.0');
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/style/style.css', array(), '1.0', 'all');
...
add_filter( 'get_search_form', 'wpdocs_my_search_form' ); //Custom Search form
// Remove Filters
