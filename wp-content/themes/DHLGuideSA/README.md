# [SB Blank WP](http://html5blank.com)

Includes Bootstrap v3 and SCSS files set up ready to go. 

Its basically HTML5Blank theme with Bootstrap the below is for that... 
